...
![The three brakes cheatsheet](figures/00-agent-brakes.png)
...
![Typing the task with /no-eager](figures/02-no-eager.png)
...
![The no-eager prompt expands](figures/03-prompt-expand.png)
*The `/no-eager` skill expands into a full posture before the agent does anything.*
![Research done](figures/04-research-done.png)
...
![/approval](figures/12-approval.png)
*`/approval` — the agent must lay out a full plan and wait.*
![The full plan, waiting for an explicit yes](figures/13-approval-done.png)
...
![go](figures/14-go.png)
*`go` — brakes off.*
![The script runs](figures/15-go-done.png)
