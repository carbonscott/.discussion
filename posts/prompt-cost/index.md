...
![What is Agentic AI?](externals/01.png)
...
![claude-code-mini.py — about 60 lines, pure stdlib](externals/02.png)
...
![The agent loop — call, detect, run, feed](externals/03.png)
...
![Filling up the context window](externals/04.png)
...
![Submit the entire context — including tokens that have been processed before](externals/05.png)
...
![Token (KV) Cache — Anthropic price table](externals/06.png)
